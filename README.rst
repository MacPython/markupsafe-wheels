...
Repository to build markupsafe wheels.
...
* Update markupsafe submodule with version you want to build:

    * cd markupsafe && git pull && git checkout DESIRED_COMMIT
...
account.  Either contact me to get set up, or use another upload service such
as github - see for example Jonathan Helmus' `sckit-image wheels builder
